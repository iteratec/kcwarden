...
from kcwarden.auditors.idp.saml_identity_provider_without_encrypted_assertions import (
    SamlIdentityProviderWithoutEncryptedAssertions,
)
from kcwarden.custom_types import config_keys


class TestSamlIdentityProviderWithoutEncryptedAssertions:
    @pytest.fixture
    def auditor(self, database, default_config):
        auditor_instance = SamlIdentityProviderWithoutEncryptedAssertions(database, default_config)
