...
from kcwarden.auditors.idp.saml_identity_provider_without_signed_authn_requests import (
    SamlIdentityProviderWithoutSignedAuthnRequests,
)
from kcwarden.custom_types import config_keys


class TestSamlIdentityProviderWithoutSignedAuthnRequests:
    @pytest.fixture
    def auditor(self, database, default_config):
        auditor_instance = SamlIdentityProviderWithoutSignedAuthnRequests(database, default_config)
